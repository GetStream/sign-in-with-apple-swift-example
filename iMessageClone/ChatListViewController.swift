...
class MessagesListViewController: ChannelsViewController {
    ...
    override func dequeueChannelCell(at indexPath: IndexPath) -> ChannelTableViewCell {
        tableView.dequeueReusableCell(withIdentifier: ChatListCell.reuseIdentifier) as! ChatListCell
    }
    
    override func channelCell(at indexPath: IndexPath, channelPresenter: ChannelPresenter) -> UITableViewCell {
        let cell = super.channelCell(at: indexPath, channelPresenter: channelPresenter) as! ChatListCell
